...
if ( ! function_exists( 'deploy_svg_icon' ) ) {
...
if ( ! function_exists( 'deploy_the_posts_navigation' ) ) {
	function deploy_the_posts_navigation( $args = array(), $base = false, $query = false ) {
